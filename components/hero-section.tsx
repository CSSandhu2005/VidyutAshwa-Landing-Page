          ...
          <div className="relative mx-auto max-w-5xl px-6 pt-28 lg:pt-24">
            <div className="relative z-10 mx-auto max-w-2xl text-center">
              <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-6xl">
                Team VidyutAshwa <br /> #Forging Legacy
              </h1>
              <p className="text-muted-foreground mx-auto my-8 max-w-2xl text-xl">
                VidyutAshwa builds autonomous Baja systems combining safety,
                precision engineering, resilience, teamwork, innovation,
                testing, competition readiness.
              </p>

              <Button asChild size="lg">
                <Link href="#">
                  <span className="btn-label">Connect With Us</span>
                </Link>
              </Button>
            </div>
          </div>
